  ...
  <form name="myform${n}" action="" class="calcform" method="GET">
    <div class="divdata">
      <ul class="tabs-menu tabs-menu${n}">
        ...
        <li><a href="#tab-resumo${n}">Resumo</a></li>
      </ul>
      <div class="tab">
        <div id="tab-carreira${n}" class="tab-content tab-content${n}">
          ...
          <div>
            <label>Reajuste:
              <input type="number" name="numProposta" id="numProposta${n}" min="0" max="200" step="0.5" value="0" style="width: 45px;" onClick="calcSalario(this.form);" onKeyUp="calcSalario(this.form);" />
              %
            </label>
          </div>
          <div>
          ...
          <div id="gratdiv${n}">
            <label>Grat. Leg.
              <input type="checkbox" name="grat" id="grat${n}" value="0" onClick="calcSalario(this.form);" />
              <input style="width: 85px;" type="text" name="txGrat" id="txGrat${n}" value="R$ 0,00" readonly />
            </label>
          </div>
          <div>
            <label>Cargo:
          ...
          <div>
            <label>Tempo de serviço (em anos):
              <input type="number" name="numTempo" id="numTempo${n}" min="0" max="100" step="0.5" value="0" style="width: 35px;" onClick="calcTempo(this.form);" onKeyPress="calcTempo(this.form);" onKeyUp="calcTempo(this.form);" />
            </label>
          </div>
          <div>
            <label>
          ...
          <div>
            <label>Quinquênio:
              <input type="number" name="numQuinquenio" id="numQuinquenio${n}" min="0" max="35" step="5" value="0" style="width: 35px;" onClick="calcSalario(this.form);" onKeyPress="calcSalario(this.form);" onKeyUp="calcSalario(this.form);" />
              %
            </label>
          </div>
          <div>
            <label>Qualificação (AQ-I a AQ-IV):
              <select name="ddQuali" id="ddQuali${n}" onchange="calcSalario(this.form);" style="width: 150px;">
          ...
          <div>
            <label>Cursos de capacitação (AQ-V):
              <input type="number" name="cursos" id="cursos${n}" min="0" max="3" step="1" value="0" style="width: 30px;" onClick="calcSalario(this.form);" onKeyUp="calcSalario(this.form);" />
            </label>
            <input type="text" name="txCursos" value="R$ 0,00" readonly /> 
          </div>
          <div>
            <label>Adic. de risco:
              <select name="ddInsa" id="ddInsa${n}" onchange="calcSalario(this.form);" style="width: 150px;">
          ...
          <div>
            <label>Nº de dep. IR:
                <input type="number" name="numDepIRRF" id="numDepIRRF${n}" min="0" max="20" step="1" value="0" style="width: 35px;" onClick="calcSalario(this.form);" onKeyPress="calcSalario(this.form);" onKeyUp="calcSalario(this.form);" />
                <input type="text" name="txDepIRRF" value="R$ 0,00" readonly />
            </label>
          </div>
          <div>
            <label>Ticket alimentação:
              <input type="checkbox" name="ticket" id="ticket${n}" value="0"onClick="calcSalario(this.form);" />
              <input type="text" name="txTicket" value="R$ 0,00" readonly />
            </label>
            <label>Sindicato:
              <select name="ddSindTipo" id="ddSindTipo${n}" onchange="calcSalario(this.form);"style="width: 110px;">
          ...
          <!-- <div id="tab-outros${n}" class="tab-content tab-content${n}">
            ...
            <div class="tab-content_col" >
              <label for="numOutrosRendTrib${n}0" style="display: inline-block;width: 85px;">Tributáveis:</label>
              R$ <input type="number" name="numOutrosRendTrib" id="numOutrosRendTrib${n}0" min="0" max="20000" step="0.01" value="0" style="width: 70px;" onKeyPress="calcSalario(this.form);" onKeyDown="calcSalario(this.form);" onKeyUp="calcSalario(this.form);" onClick="calcSalario(this.form);" />
              IR <input type="checkbox" name="outrosIR0" id="outrosIR${n}0" value="0" onClick="calcSalario(this.form);" />
              FEPA <input type="checkbox" name="outrosFEPA0" id="outrosFEPA${n}0" value="0" onClick="calcSalario(this.form);" />
            </div>
            <div style="display: block;">
              <label for="numOutrosRendIsnt${n}" style="display: inline-block;width: 85px;">Isentos:</label>
              R$ <input type="number" name="numOutrosRendIsnt" id="numOutrosRendIsnt${n}" min="0" max="20000" step="0.01" value="0" style="width: 70px;" onKeyPress="calcSalario(this.form);" onKeyDown="calcSalario(this.form);" onKeyUp="calcSalario(this.form);" onClick="calcSalario(this.form);" />
            </div>
            <h4 style="margin: 0.5em 0 0 0;">Descontos</h4>
            <div style="display: block;">
              <label for="numOutros${n}" style="display: inline-block;width: 85px;">Descontos:</label>
              R$ <input type="number" name="numOutros" id="numOutros${n}" min="0" max="10000" step="0.01" value="0" style="width: 80px;" onKeyPress="calcSalario(this.form);" onKeyDown="calcSalario(this.form);" onKeyUp="calcSalario(this.form);" onClick="calcSalario(this.form);" />
            </div>
          </div> -->
        </div><br/>
        <div id="tab-resumo${n}" class="tab-content tab-content${n}">
          <div class="divresults_col" style="float: left;">
            ...
            <br/>
            <label>C/ ticket alimentação: <input type="text" name="txCticket" value="0" readonly /></label>
          </div>
...
function renderAllForms() {
    ...
    `;
    [1, 2].forEach(n => {
        document.getElementById(`ddAno${n}`).addEventListener("change", function () {
            const form = this.form;
            //updateQuali(form, form.ddCargo.value, form.ddAno.value);
            updateQuali(form, form.ddCargo.value, form.ddAno.value);
            calcSalario(form);
        });
        document.getElementById(`ddCargo${n}`).addEventListener("change", function () {
            const form = this.form;
            //updateQuali(form, form.ddCargo.value, form.ddAno.value);
            updateQuali(form, form.ddCargo.value, form.ddAno.value);
            calcSalario(form);
